...
urlpatterns = patterns('',
    ...
    url(r'^album/$',
        ...
        name='album_list'),
    url(r'^album/(?P<pk>\d+)/$',
        DetailView.as_view(queryset=Album.objects.select_related('artist')),
        name='album_detail'),
    ...
    url(r'^song/$',
        ListView.as_view(queryset=Song.objects.select_related('artist')),
        name='song_list'),
    url(r'^song/(?P<pk>\d+)/$',
        DetailView.as_view(queryset=Song.objects.select_related(depth=1)),
        name='song_detail'),
