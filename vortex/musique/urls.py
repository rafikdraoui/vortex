...
from vortex.musique.views import (AlphabetizedListView,
                                  ArtistDetailView,
                                  AlbumDetailView,
                                  download_artist,
                                  download_album,
...
urlpatterns = patterns('',
    url(r'^artist/$', AlphabetizedListView.as_view(model=Artist), name='artist_list'),
    ...
    url(r'^album/$', AlphabetizedListView.as_view(model=Album), name='album_list'),
    ...
    url(r'^song/$', AlphabetizedListView.as_view(model=Song), name='song_list'),
